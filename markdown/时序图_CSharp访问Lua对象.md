...
opt 情况1：执行Dispose
CSharp ->> CSharp : 执行LuaTable.Dispose，LuaTable.count为0，释放CSharp侧的LuaTable（立即释放）
end
...
Lua ->> CSharp : 触发LuaState.Collect方法
CSharp ->> CSharp : 执行ObjectTranslator.RemoveObject方法，移除lua侧引用的CSharp侧object对象
